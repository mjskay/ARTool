...
Kay M and Wobbrock J (`r format(Sys.Date(), "%Y")`). _ARTool: Aligned Rank Transform for
Nonparametric Factorial ANOVAs_. R package version `r getNamespaceVersion("ARTool")`, <https://github.com/mjskay/ARTool>.
...
Elkin L, Kay M, Higgins J and Wobbrock J (2021). "An Aligned Rank Transform Procedure for Multifactor Contrast Tests." 
[arXiv eprint: 2102.11824](https://arxiv.org/abs/2102.11824).
